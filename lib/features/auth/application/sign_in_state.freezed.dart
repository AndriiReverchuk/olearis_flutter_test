...
class _$SignInStateImpl extends _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(login: $login, password: $password, isLoading: $isLoading, isSuccess: $isSuccess, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, login, password, isLoading, isSuccess, errorMessage);
